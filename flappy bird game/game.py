...
def welcomeScreen():
    ...
    while True:
        for event in pygame.event.get():
            # clicks on cross button to close the game
...
def mainGame():
    ...
    # Create upper and lower pipes for blitting on the screen
...
if __name__ == "__main__":
    ...
    GAME_SOUNDS['gameover'] = pygame.mixer.Sound('sound/gameover.mp3')
